...
public class CreateProject {
	...
	CreateAufgabenbereich editClass;
	static Map<Integer, CreateAufgabenbereich> editFrames = new HashMap <>();
	...
	private void initialize() {
		...
		btnCreateProject.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				editClass = new CreateAufgabenbereich();  //make new edit class frame
