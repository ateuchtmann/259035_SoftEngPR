...
public class TaskView {
	...
	private void initialize() {
		...
		JButton managageActivities = new JButton("Zeiterfassung");
		managageActivities.setBounds(180, 81, 120, 16);
		
		createActivityViewMap.put(managageActivities, createActView);
		
		
		managageActivities.addActionListener(new ActionListener() {  
			public void actionPerformed(ActionEvent arg0) {
			
				CreateActivityView newCreateActView =  createActivityViewMap.get(managageActivities);
		...
		taskPanel.add(managageActivities);
